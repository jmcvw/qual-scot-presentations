...
- Current stats summary is table first, with figures hidden in accordions
...
Both presentation are hosted in GH pages, and can be accessed [here](https://jmcvw.github.io/qual-scot-presentations/)
